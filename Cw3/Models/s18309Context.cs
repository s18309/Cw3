...
{
    public partial class s18309Context : DbContext
    {
        public s18309Context()
        {
        }

        public s18309Context(DbContextOptions<s18309Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18309;Integrated Security=True");
            }
        }
